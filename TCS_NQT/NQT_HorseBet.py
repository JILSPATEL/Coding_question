...
n = int(input("enter the number of horse :"))
k = int(input("enter the maximum bid amount :"))
arr = []
for i in range(0, n):
    ip = int(input(f"enter amount for horse no.{i+1} :"))
    arr.append(ip)

print(optimalBid(n, k, arr))
